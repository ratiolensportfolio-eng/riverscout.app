...
export const PRO_FEATURES: ProFeature[] = [
  ...
  { icon: '\uD83C\uDF0A', title: '72-hour flow forecast', description: 'See where CFS is heading before you drive', available: false },
  { icon: '\uD83D\uDCF1', title: 'Offline river pages', description: 'Works without cell service', available: false },
  { icon: '\uD83D\uDCC8', title: 'Historical flow analysis', description: '10-year CFS patterns by week', available: false },
  { icon: '\uD83C\uDFAF', title: 'Custom optimal CFS ranges', description: 'Set your own ideal ranges per river', available: false },
