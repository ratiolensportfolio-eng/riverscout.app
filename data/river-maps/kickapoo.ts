...
export const accessPoints: AccessPoint[] = [
  ...
  { name: 'Village Park Landing', lat: 43.18223, lng: -90.85819, type: 'access' },
  { name: 'Plum Creek Landing', lat: 43.11448, lng: -90.91266, type: 'access', description: 'Wildlife Biologist' },
  { name: 'Village Park Landing', lat: 43.31975, lng: -90.85105, type: 'access' },
  ...
  { name: 'WAUZEKA BOAT LANDING', lat: 43.08481, lng: -90.87910, type: 'access' },
  ...
  { name: 'Village Park Access', lat: 43.39393, lng: -90.77552, type: 'access' },
  { name: 'LA FARGE CANOE LAUNCH', lat: 43.57484, lng: -90.64379, type: 'access', description: 'Village Hall' },
  { name: 'Kickapoo River Landing 4', lat: 43.69775, lng: -90.60262, type: 'access' },
